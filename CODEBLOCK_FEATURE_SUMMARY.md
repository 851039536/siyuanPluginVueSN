...
## 功能概述
在通用设置中新增了代码块美化设置，支持四种风格：默认、GitHub、Mac 和卡通风格，并新增了代码块折叠功能。
...
- `docs/CODEBLOCK_COLLAPSE_FEATURE.md` - 新增折叠功能说明文档
...
### 代码块折叠功能
1. **智能折叠** - 自动检测代码块高度并添加折叠按钮
2. **高度可调** - 支持 200px-800px 范围内自定义折叠高度
3. **编辑友好** - 编辑代码块时自动展开
4. **主题适配** - 支持浅色和深色主题的折叠样式
5. **移动端优化** - 移动端触摸优化的展开按钮
