...
├── index.scss                   # 全局样式入口
├── commands/                    # 斜杠命令
├── components/                  # 共享 UI 组件（38 个原子组件；自包含：kit/ 内含 icons.ts 与 variables.scss 真源）
