...
5. Use `pnpm dev` to run the project, you will see info like below
  ...
  > siyuan-plugin-vite-vue-sn@0.0.1 dev /path/to/your/siyuan-plugin-vite-vue-sn
  > vite build --watch
  ...
  /path/to/siyuan/workspace/data/plugins/siyuan-plugin-vite-vue-sn

  isWatch=> true
  distDir=> /path/to/siyuan/workspace/data/plugins/siyuan-plugin-vite-vue-sn
  ...
  ../../Siyuan-plugin/data/plugins/siyuan-plugin-vite-vue-sn/index.css    1.08 kB │ gzip:  0.41 kB
  ../../Siyuan-plugin/data/plugins/siyuan-plugin-vite-vue-sn/index.js   198.60 kB │ gzip: 46.59 kB
  [vite-plugin-static-copy] Copied 7 items.
  built in 502ms.
  ```


   If successed, restart your siyuan, and you will find the plugin in `Siyuan - Settings - Marketplace`, named as `siyuan-plugin-vite-vue-sn`.
