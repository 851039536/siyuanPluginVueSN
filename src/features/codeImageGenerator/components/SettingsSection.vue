    ...
    <div class="settings-row">
      ...
      <div class="setting-item">
        ...
        <div class="size-control">
          <button class="size-btn" @click="onStep(-1)" tabindex="-1">
            <svg width="10" height="10" viewBox="0 0 10 10"><path d="M7 2L3 5L7 8" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </button>
          <div class="size-slider" ref="sliderRef" @mousedown="onDragStart" @touchstart.prevent="onTouchStart">
            <div class="size-track" />
            <div class="size-fill" :style="{ width: percent + '%' }" />
            <div class="size-thumb" :style="{ left: percent + '%' }" />
          </div>
          <button class="size-btn" @click="onStep(1)" tabindex="-1">
            <svg width="10" height="10" viewBox="0 0 10 10"><path d="M3 2L7 5L3 8" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </button>
