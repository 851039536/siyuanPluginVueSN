...
import type { CommitAnalysisEntry, CommitAnalysisType, FetchFailureKind, FileChange, GitOpLogEntry, GitProject, GitRemoteInfo, PlatformKey, ProjectLineRankItem, RemotePushStatus } from "./types"
...
// ── 项目抓取失败原因（路径预检 / git 命令报错 → 可展示的分类 + 原始文本）──
