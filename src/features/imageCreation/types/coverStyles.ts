// ============================================================
// 封面风格注册表（共享配置表：colors + decorHtml + buildDecorCss 三位一体）
// 基础 5 风格 + 新增风格（types/coverStylesNew.ts）合并导出；
...
const BASE_STYLES: StyleDefinition[] = [
  {
    id: "minimal",
    label: "极简",
