...
<template>
  <div class="settings-container">
    ...
    <ManualBackupCard
      ...
      :is-configured="orch.isConfigured"
      :workspace-path="orch.workspacePath"
      ...
      :is-incremental-running="orch.isIncrementalRunning"
      :is-incremental-restoring="orch.isIncrementalRestoring"
      :i18n="i18n"
      @perform-backup="orch.performManualBackup()"
      @trigger-zip-backup="orch.triggerZipBackupOnly()"
      @trigger-incremental="orch.triggerIncrementalOnly()"
      @trigger-incremental-restore="orch.triggerIncrementalRestore()"
